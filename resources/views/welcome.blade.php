...
<body class="bg-white">
    ...
    <div class="appHeader no-border transparent">
        <div class="pageTitle">Welcome to Tunas Toyota Mampang</div>
        <div class="right">
        </div>
    </div>
    <!-- * App Header -->
        ...
        <div class="carousel-slider splide">
            <div class="splide__track">
                <ul class="splide__list">
                    ...
                    <li class="splide__slide p-2">
                        <img src="assets/img/isometric3.jpg" alt="alt" class="imaged w-100 square mb-4">
                        <h2>Personal Asisstant Apps</h2>
                        <p>Rasakan pelayanan terbaik dari Tunas Toyota Mampang.</p>
                    </li>
                    <li class="splide__slide p-2">
                        <img src="assets/img/isometric2.png" alt="alt" class="imaged w-100 square mb-4">
                        <h2>Personal Assistant Apps</h2>
