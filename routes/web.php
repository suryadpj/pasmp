...
Route::post('simpanreservasi', [ReservasiController::class, 'simpanreservasi'])->name('simpanreservasi');
Route::get('/konfirmasireservasi/{nomorplat}', [ReservasiController::class, 'konfirmasi'])->name('konfirmasi');
...
Route::get('/showpart/{kendaraan}/{paket}/{km}/{transmisi}/{kat}', [ReservasiController::class, 'showpart'])->name('showpart');
Route::get('/sumpart/{kendaraan}/{paket}/{km}/{transmisi}/{kat}', [ReservasiController::class, 'sumpart'])->name('sumpart');
Route::get('/sumparmat/{kendaraan}/{paket}/{km}/{transmisi}/{kat}', [ReservasiController::class, 'sumparmat'])->name('sumparmat');
